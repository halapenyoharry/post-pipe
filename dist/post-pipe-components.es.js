...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), s = (e, i, o, s) => {
	...
	function To(e, t, n, r, i, a) {
		return go = a, L = t, t.memoizedState = null, t.updateQueue = null, t.lanes = 0, D.H = e === null || e.memoizedState === null ? Bs : Vs, yo = !1, a = n(r, i), yo = !1, vo && (a = Do(t, n, r, i)), Eo(e), a;
	}
	function Eo(e) {
		D.H = zs;
	...
	function No(e) {
		var t = xo;
		return xo += 1, So === null && (So = []), e = Na(So, e, t), t = L, (z === null ? t.memoizedState : z.next) === null && (t = t.alternate, D.H = t === null || t.memoizedState === null ? Bs : Vs), e;
	}
	function Po(e) {
		if (typeof e == "object" && e) {
	...
	function Cu(e, t) {
		L = null, D.H = zs, t === Oa || t === Aa ? (t = Ia(), Y = 3) : t === ka ? (t = Ia(), Y = 4) : Y = t === rc ? 8 : typeof t == "object" && t && typeof t.then == "function" ? 6 : 1, Bl = t, q === null && (X = 1, Zs(e, Ti(t, e.current)));
	}
	function wu() {
		var e = P.current;
...
var co = { graphContainer: "_graphContainer_21ie6_1" }, P = {
	card: "_card_1ykbq_5",
...
function Co({ feedData: e, onNodeSelect: t, hiddenSources: n, viewState: r, layout: i = "force", timeAxis: a, graphSettings: o }) {
	...
	let g = So(c), _ = c.glowPadding, v = (0, j.useRef)(null), y = (0, j.useRef)(i), b = (0, j.useRef)(!1), x = (0, j.useRef)(null), S = (0, j.useRef)(null), C = (e) => e.originalItem && e.originalItem.id || e.id, w = (e) => y.current + "::" + C(e), T = (0, j.useRef)(null), ee = (0, j.useRef)(null), te = (0, j.useRef)(1), E = (0, j.useRef)("full"), ne = (0, j.useRef)(/* @__PURE__ */ new Set());
	(0, j.useEffect)(() => {
		ne.current = n instanceof Set ? n : new Set(n || []), p.current && vo(p.current, ne.current);
	}, [n]), (0, j.useEffect)(() => {
		...
		let s = o.append("g"), u = so().on("zoom", (e) => {
			...
			let n = xo(t);
			n !== E.current && (E.current = n, fe());
		});
		o.call(u).on("dblclick.zoom", null);
		let b = !1;
		if (h.current && (b = (0, z.layoutIsDegenerate)(a.nodes.map((e) => h.current.nodeState(w(e))).filter((e) => e && Number.isFinite(e.x) && Number.isFinite(e.y)), g({
			hovered: !1,
			pinned: !1
		}))), h.current && !b) for (let e of a.nodes) {
			let t = h.current.nodeState(w(e)), n = h.current.nodeState(C(e));
			...
			let t = h.current.nodeState(C(e));
			t && typeof t.w == "number" && typeof t.h == "number" && (e._size = {
				width: t.w,
				height: t.h
			});
		}
		let re = Ka().force("link", La().id((e) => e.id).distance(d.linkDistance)).force("charge", qa().strength(d.chargeStrength)).force("collide", Pa().radius((e) => (e._r || e.size / 2) + d.collidePadding).strength(1).iterations(3)).force("center", sa(n / 2, r / 2)).velocityDecay(d.velocityDecay).alphaDecay(d.alphaDecay), ie = () => {
			x.current && x.current(), f.current && (n = f.current.clientWidth, r = f.current.clientHeight, o.attr("width", n).attr("height", r));
		};
		window.addEventListener("resize", ie);
		let ae = o.append("g").attr("class", "time-axis-layer"), oe = s.selectAll(".link").data(a.links).enter().append("line").attr("class", "link"), se = s.selectAll(".node").data(a.nodes).enter().append("g").attr("class", "node").call(on().filter((e) => {
			...
			if (t._resizing) {
				...
				}, k(t), h.current && h.current.setNodeSize(C(t), t._size.width, t._size.height, { transient: !0 });
				return;
			}
			t.x = e.x, t.y = e.y, t.fx = e.x, t.fy = e.y, h.current && h.current.setNodePosition(C(t), e.x, e.y, { transient: !0 }), se.filter((e) => e.id === t.id).attr("transform", "translate(" + e.x + "," + e.y + ")"), S.current && S.current(), oe.each(function(e) {
		...
		})), ce = o.append("text").style("font-family", "'Atkinson', sans-serif").style("visibility", "hidden"), D = typeof document < "u" ? document.createElement("canvas").getContext("2d") : null;
		function O(e, t) {
			if (!D) return {
				width: e.length * t * .5,
				ascent: t * .7,
		...
		let le = [];
		function ue(e) {
			let { d: t, textEl: n, rectEl: r, lines: i, fontSize: a, lineH: o } = e, s = i.map((e) => O(e, a)), c = i.map((e, t) => t * o), u = Math.min(...c.map((e, t) => e - s[t].ascent)), d = Math.max(...c.map((e, t) => e + s[t].descent)), f = -(u + d) / 2, p = u + f, m = d + f, h = Math.max(...s.map((e) => e.width));
		...
		se.each(function(e) {
			...
			if (e.type !== "article") {
				...
				let o = (e) => (ce.text(e), ce.node().getComputedTextLength()), s = e.label.split(/(?<=-)|\s+/).filter(Boolean), c = (e) => e.join("").replace(/\s+$/, "").trim(), u = [e.label];
		...
		se.filter((e) => e.type === "article").each(function(e) {
			let t = Wt(this).select("foreignObject.article-fo").node(), n = document.createElementNS("http://www.w3.org/1999/xhtml", "div");
			n.style.width = "100%", n.style.height = "100%", n.style.boxSizing = "border-box", t.appendChild(n), de.set(e.id, {
		...
		function k(e) {
			...
			let t = de.get(e.id);
			if (!t) return;
			let n = ee.current === e.id, r = T.current === e.id, i = xo(te.current), { width: a, height: o } = e._size || g({
				hovered: n,
				pinned: r
			});
		...
		se.filter((e) => e.type === "article").select("foreignObject.article-fo").on("wheel", (e) => e.stopPropagation());
		function fe() {
			a.nodes.forEach((e) => {
				e.type === "article" && k(e);
			});
		...
		function pe(e) {
			if (A.has(e.id)) return e._fullContent = A.get(e.id), Promise.resolve();
			let t = !1;
			try {
			...
			return t ? fetch(e.url).then((e) => {
				...
				A.set(e.id, i), e._fullContent = i;
			}).catch(() => {
				A.set(e.id, null), e._fullContent = null;
			}) : (A.set(e.id, null), e._fullContent = null, Promise.resolve());
		}
		fe(), vo(o, ne.current), se.filter((e) => e.type === "article").on("mouseover", (e, t) => {
			ee.current !== t.id && (ee.current = t.id, k(t));
		}).on("mouseout", (e, t) => {
			let n = e.relatedTarget;
			n && e.currentTarget.contains(n) || ee.current === t.id && (ee.current = null, k(t));
		}).on("dblclick", (e, t) => {
			e.stopPropagation(), e.preventDefault(), m.current && m.current(t.originalItem || t), T.current = null, ee.current = null, k(t);
		}).on("click", (e, t) => {
			let n = e.target;
			if (n && (n.dataset?.popout === "1" || n.closest?.("[data-popout=\"1\"]"))) {
				e.stopPropagation(), m.current && m.current(t.originalItem || t), T.current === t.id && (T.current = null, ee.current = null, k(t));
				return;
			}
			e.stopPropagation();
			let r = T.current;
			if (r === t.id) T.current = null, k(t);
			else {
				if (T.current = t.id, k(t), se.filter((e) => e.id === t.id).raise(), r) {
		...
		se.filter((e) => e.type !== "article").on("click", (e, t) => {
			if (e.stopPropagation(), me === t.id) me = null, se.classed("dimmed", !1).classed("tag-active", !1), oe.classed("highlighted", !1);
			else {
				me = t.id;
			...
			if (me && (me = null, se.classed("dimmed", !1).classed("tag-active", !1), oe.classed("highlighted", !1)), T.current, T.current) {
				let e = a.nodes.find((e) => e.id === T.current);
				T.current = null, e && k(e);
			}
		});
		function he() {
			oe.attr("x1", (e) => e.source.x).attr("y1", (e) => e.source.y).attr("x2", (e) => e.target.x).attr("y2", (e) => e.target.y), se.attr("transform", (e) => "translate(" + e.x + "," + e.y + ")");
		}
		v.current = {
			data: a,
			nodes: se,
		...
		re.nodes(a.nodes).on("tick", () => {
			he(), S.current && S.current(), x.current && ++ge % 25 == 0 && x.current();
		}), re.force("link").links(a.links), he();
		let _e = !1;
		function ve() {
			let e = a.nodes.filter((e) => e.type === "article");
			if (e.length < 2) return !1;
			let t = e.map((e) => e.x), n = e.map((e) => e.y), r = Math.min(...t) - 140, i = Math.max(...t) + 140, s = Math.min(...n) - 140, c = Math.max(...n) + 140, l = f.current ? f.current.clientWidth : window.innerWidth, d = f.current ? f.current.clientHeight : window.innerHeight;
			if (l < 50 || d < 50) return !1;
			let p = Math.min(l / Math.max(i - r, 1), d / Math.max(c - s, 1), 1), m = l / 2 - (r + i) / 2 * p, h = d / 2 - (s + c) / 2 * p;
			return o.call(u.transform, Za.translate(m, h).scale(p)), !0;
		}
		let ye = !1;
		re.on("end", () => {
			if (ye = !0, y.current !== "force") return;
			a.nodes.forEach((e) => {
			...
			let t = !1;
			if (e) for (let n of a.nodes) !b && e.nodeState(w(n)) ? t = !0 : e.setNodePosition(w(n), n.x, n.y, { silent: !0 });
			t || (_e = ve()), x.current && x.current();
		});
		let be = () => {
			if (!document.hidden) {
				if (!ye) {
		...
		return document.addEventListener("visibilitychange", be), () => {
			re.stop(), document.removeEventListener("visibilitychange", be), window.removeEventListener("resize", ie), de.forEach(({ root: e }) => {
	...
	function re(e, t) {
		...
		let n = f.current, r = n ? n.clientWidth : window.innerWidth, i = n ? n.clientHeight : window.innerHeight;
		if (r < 60 || i < 60) return;
		let a = t.dock || u.dock, o = a === "left" || a === "right", s = u.endPadding, c = Number.isFinite(t.offset) ? t.offset : u.inset, l = a === "right" ? r - c : a === "bottom" ? i - c : c, d = Math.max((o ? i : r) - s * 2, 120), p = o ? {
			x: l,
			y: s
		} : {
			x: s,
		...
		if (!m) return;
		let g = e.axisLayer.append("g").attr("class", "time-axis"), _ = g.append("g").attr("class", "time-connectors"), v = [];
		e.data.nodes.forEach((e) => {
			let t = m.anchors[e.id];
			if (!t) return;
			let n = _.append("line").attr("class", "time-connector").attr("data-node", e.id).attr("x1", t.x).attr("y1", t.y).attr("stroke", e._source && e._source.color || "#7f8ea3").attr("stroke-width", u.connectorWidth).attr("stroke-opacity", u.connectorOpacity);
			v.push({
				node: e,
				anchor: t,
				line: n
		...
		S.current = y, y();
		let x = g.append("g").attr("class", "time-spine").style("cursor", o ? "ew-resize" : "ns-resize");
		x.append("rect").attr("x", o ? l - 34 / 2 : 0).attr("y", o ? 0 : l - 34 / 2).attr("width", o ? 34 : r).attr("height", o ? i : 34).attr("fill", "rgba(18,20,28,0.82)"), x.append("line").attr("x1", m.from.x).attr("y1", m.from.y).attr("x2", m.to.x).attr("y2", m.to.y).attr("stroke", "rgba(255,255,255," + u.spineOpacity + ")").attr("stroke-width", u.spineWidth);
		let C = u.tickFontSize, w = m.ticks.length > 1 ? Math.hypot(m.ticks[1].x - m.ticks[0].x, m.ticks[1].y - m.ticks[0].y) : Infinity, T = o ? C * 1.7 : C * 4.2, ee = Math.max(1, Math.ceil(T / Math.max(w, 1)));
		m.ticks.forEach((e, t) => {
		...
		x.call(on().on("start", (e) => {
			...
			if (te !== null && E && h.current) {
				let e = a === "right" || a === "bottom" ? c - E : c + E;
				h.current.setTimeAxis({
