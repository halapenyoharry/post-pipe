...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), s = (e, i, o, s) => {
	...
	function po(e) {
		var t = e.alternate;
		D(F, F.current & 1), D(uo, e), fo === null && (t === null || ao.current !== null || t.memoizedState !== null) && (fo = e);
	}
	function N(e) {
		D(F, F.current), D(uo, e), fo === null && (fo = e);
	}
	function mo(e) {
		e.tag === 22 ? (D(F, F.current), D(uo, e), fo === null && (fo = e)) : ho(e);
	}
	function ho() {
		D(F, F.current), D(uo, uo.current);
	}
	function P(e) {
		E(uo), fo === e && (fo = null), E(F);
	}
	var F = he(0);
	function go(e) {
		for (var t = e; t !== null;) {
	...
	function ws(e, t, n, r) {
		return Mr(n, t) ? n : ao.current === null ? !(_o & 42) || _o & 1073741824 && !(J & 261930) ? (V = !0, e.memoizedState = n) : (e = mu(), I.lanes |= e, Gl |= e, t) : (e = Cs(e, n, r), Mr(e, t) || (V = !0), e);
	}
	...
	function ic(e, t, n, r, a) {
		if (n.flags |= 32768, typeof r == "object" && r && typeof r.then == "function") {
			if (t = n.alternate, t !== null && oa(t, n, a, !0), n = uo.current, n !== null) {
				switch (n.tag) {
					case 31:
					case 13: return fo === null ? Du() : n.alternate === null && X === 0 && (X = 3), n.flags &= -257, n.flags |= 65536, n.lanes = a, r === Ma ? n.flags |= 16384 : (t = n.updateQueue, t === null ? n.updateQueue = new Set([r]) : t.add(r), Gu(e, r, a)), !1;
	...
	function hc(e, t, n) {
		...
		if (t.flags &= -129, e === null) {
			if (j) {
				...
				if (N(t), (e = A) ? (e = rf(e, Wi), e = e !== null && e.data === "&" ? e : null, e !== null && (t.memoizedState = {
					dehydrated: e,
		...
		if (o !== null) {
			var s = o.dehydrated;
			if (N(t), a) if (t.flags & 256) t.flags &= -257, t = mc(e, t, n);
	...
	function wc(e, t, n) {
		...
		if ((s = o) || (s = e !== null && e.memoizedState === null ? !1 : (F.current & 2) != 0), s && (a = !0, t.flags &= -129), s = (t.flags & 32) != 0, t.flags &= -33, e === null) {
			if (j) {
				if (a ? po(t) : ho(t), (e = A) ? (e = rf(e, Wi), e = e !== null && e.data !== "&" ? e : null, e !== null && (t.memoizedState = {
					dehydrated: e,
					treeContext: Pi === null ? null : {
						id: Fi,
						overflow: Ii
			...
			return r = r.fallback, a ? (ho(t), a = t.mode, c = Ec({
				mode: "hidden",
				children: c
			}, a), r = Si(r, a, n, null), c.return = t, r.return = t, c.sibling = r, t.child = c, r = t.child, r.memoizedState = Sc(n), r.childLanes = Cc(e, s, n), t.memoizedState = xc, dc(null, r)) : (po(t), Tc(t, c));
		}
		var l = e.memoizedState;
		if (l !== null && (c = l.dehydrated, c !== null)) {
			if (o) t.flags & 256 ? (po(t), t.flags &= -257, t = Dc(e, t, n)) : t.memoizedState === null ? (ho(t), c = r.fallback, a = t.mode, r = Ec({
				mode: "visible",
				children: r.children
		...
		return a ? (ho(t), c = r.fallback, a = t.mode, l = e.child, u = l.sibling, r = yi(l, {
			...
			cachePool: a
		}), r.memoizedState = c, r.childLanes = Cc(e, s, n), t.memoizedState = xc, dc(e.child, r)) : (po(t), n = e.child, e = n.sibling, n = yi(n, {
			mode: "visible",
			children: r.children
	...
	function Ac(e, t, n) {
		...
		if (s ? (o = o & 1 | 2, t.flags |= 128) : o &= 1, D(F, o), oc(e, t, r, n), r = j ? ji : 0, !s && e !== null && e.flags & 128) a: for (e = t.child; e !== null;) {
	...
	function Nc(e, t, n) {
		switch (t.tag) {
			...
			case 19:
				...
				if (i = t.memoizedState, i !== null && (i.rendering = null, i.tail = null, i.lastEffect = null), D(F, F.current), r) break;
				return null;
	...
	function Bc(e, t, n) {
		...
		switch (Bi(t), t.tag) {
			...
			case 19:
				...
				if (a = (t.flags & 128) != 0, o = r.rendering, o === null) if (a) zc(r, !1);
					...
					if (X !== 0 || e !== null && e.flags & 128) for (e = t.child; e !== null;) {
						if (o = go(e), o !== null) {
							...
							return D(F, F.current & 1 | 2), j && Li(t, r.treeForkCount), t.child;
						}
						e = e.sibling;
					}
				...
				return r.tail === null ? (H(t), null) : (e = r.tail, r.rendering = e, r.tail = e.sibling, r.renderingStartTime = Ie(), e.sibling = null, n = F.current, D(F, a ? n & 1 | 2 : n & 1), j && Li(t, r.treeForkCount), e);
			case 22:
			case 23: return P(t), lo(), r = t.memoizedState !== null, e === null ? r && (t.flags |= 8192) : e.memoizedState !== null !== r && (t.flags |= 8192), r ? n & 536870912 && !(t.flags & 128) && (H(t), t.subtreeFlags & 6 && (t.flags |= 8192)) : H(t), n = t.updateQueue, n !== null && Rc(t, n.retryQueue), n = null, e !== null && e.memoizedState !== null && e.memoizedState.cachePool !== null && (n = e.memoizedState.cachePool.pool), r = null, t.memoizedState !== null && t.memoizedState.cachePool !== null && (r = t.memoizedState.cachePool.pool), r !== n && (t.flags |= 2048), e !== null && E(Ta), null;
	...
	function Vc(e, t) {
		switch (Bi(t), t.tag) {
			...
			case 13:
				...
				return e = t.flags, e & 65536 ? (t.flags = e & -65537 | 128, t) : null;
			case 19: return E(F), null;
			case 4: return xe(), null;
			case 10: return ra(t.type), null;
			case 22:
			case 23: return P(t), lo(), e !== null && E(Ta), e = t.flags, e & 65536 ? (t.flags = e & -65537 | 128, t) : null;
...
function _e(e) {
	return this.selectAll(e == null ? D : ge(typeof e == "function" ? e : T(e)));
}
//#endregion
...
function Et(e, t) {
	var n = typeof e == "function" ? e : re(e), r = t == null ? Tt : typeof t == "function" ? t : ae(t);
	return this.select(function() {
...
function Ya(e) {
	var t = ja(.1), n, r, i;
	typeof e != "function" && (e = ja(e == null ? 0 : +e));
	function a(e) {
	...
	return a.initialize = function(e) {
		...
		return arguments.length ? (t = typeof e == "function" ? e : ja(+e), o(), a) : t;
	}, a.x = function(t) {
		return arguments.length ? (e = typeof t == "function" ? t : ja(+t), o(), a) : e;
	}, a;
}
//#endregion
...
function uo() {
	var e = io, t = ao, n = lo, r = so, i = co, a = [0, Infinity], o = [[-Infinity, -Infinity], [Infinity, Infinity]], s = 250, c = yr, l = v("start", "zoom", "end"), u, d, f, p = 500, m = 150, h = 0, g = 10;
	function _(e) {
	...
	function ne(t, ...r) {
		...
		$t(t.view), no(t), a.mouse = [c, this.__zoom.invert(c)], Yr(this), a.start();
		function d(e) {
			if (ro(e), !a.moved) {
		...
		function p(e) {
			s.on("mousemove.zoom mouseup.zoom", null), en(e.view, a.moved), ro(e), a.event(e).end();
		}
	}
	function re(r, ...i) {
	...
	function ie(t, ...n) {
		if (e.apply(this, arguments)) {
			...
			for (no(t), s = 0; s < i; ++s) c = r[s], l = O(c, this), l = [
				l,
	...
	function ae(e, ...t) {
		if (this.__zooming) {
			...
			for (ro(e), s = 0; s < a; ++s) c = i[s], l = O(c, this), r.touch0 && r.touch0[2] === c.identifier ? r.touch0[0] = l : r.touch1 && r.touch1[2] === c.identifier && (r.touch1[0] = l);
...
function ho({ feedData: e, onNodeSelect: t }) {
	let n = (0, k.useRef)(null), r = (0, k.useRef)(null), i = (0, k.useRef)(null), a = (0, k.useRef)(null), o = (0, k.useRef)(null), [s, c] = (0, k.useState)({
		show: !1,
		x: 0,
		y: 0,
		title: "",
	...
	return (0, k.useEffect)(() => {
		...
		qt(r).selectAll("svg").remove();
		let p = qt(r).append("svg").attr("width", s).attr("height", l).call(uo().on("zoom", (e) => {
			m.attr("transform", e.transform);
		})).on("dblclick.zoom", null);
		i.current = p;
		let m = p.append("g"), h = qa().force("link", Ra().id((e) => e.id).distance(160)).force("charge", Ja().strength(-500)).force("collide", Fa().radius((e) => (e._r || e.size / 2) + 8).strength(.9)).force("center", la(s / 2, l / 2)).velocityDecay(.85).alphaDecay(.05);
		a.current = h;
		let g = () => {
			n.current && (s = n.current.clientWidth, l = n.current.clientHeight, p.attr("width", s).attr("height", l), h.force("center", la(s / 2, l / 2)), h.alpha(.1).restart());
		};
		window.addEventListener("resize", g), o.current = g;
		let _ = m.selectAll(".link").data(f.links).enter().append("line").attr("class", "link"), v = m.selectAll(".node").data(f.nodes).enter().append("g").attr("class", "node").call(cn().on("start", (e, t) => {
		...
		return v.filter((e) => e.type === "tag").on("click", (e, t) => {
			if (e.stopPropagation(), b === t.id) b = null, v.classed("dimmed", !1).classed("tag-active", !1), _.classed("highlighted", !1), h.force("x", null).force("y", null), h.alpha(.4).restart();
				...
				let n = s / 2, r = l / 2;
				h.force("x", Ya((t) => e.has(t.id) ? n : t.x < n ? n - 500 : n + 500).strength((t) => e.has(t.id) ? .3 : .15)).force("y", Xa(r).strength((t) => e.has(t.id) ? .3 : .1)), h.alpha(.6).restart();
			}
		}), p.on("click", () => {
	...
	}, [e, t]), /* @__PURE__ */ (0, N.jsxs)(N.Fragment, { children: [/* @__PURE__ */ (0, N.jsx)("div", {
		ref: n,
		className: fo.graphContainer
	}), s.show && /* @__PURE__ */ (0, N.jsxs)("div", {
		ref: r,
		...
		children: [
			/* @__PURE__ */ (0, N.jsx)("div", {
				className: fo.tooltipTitle,
				children: s.title
			}),
			/* @__PURE__ */ (0, N.jsx)("div", {
				className: fo.tooltipDesc,
				children: s.desc
			}),
			/* @__PURE__ */ (0, N.jsx)("div", {
				className: fo.tooltipDate,
				children: s.date
			})
		]
	})] });
...
function go({ article: e, onClose: t, settings: n }) {
	let [r, i] = (0, k.useState)(!1), [a, o] = (0, k.useState)(!1), [s, c] = (0, k.useState)(""), [l, u] = (0, k.useState)(0), [d, f] = (0, k.useState)(!1), p = (0, k.useRef)(null);
	(0, k.useEffect)(() => {
	...
	let m = async (e) => {
		...
		if (t === "essay" || t === "multi") try {
			...
			i && i.remove(), c((r.querySelector("body") ? r.querySelector("body").innerHTML : n) + I(e));
		} catch {
			c(_o(e, "Rendered article not yet published to GitHub Pages."));
		}
		else c(t === "image" ? (e.image ? `<img src="${e.image}" style="max-width:100%;height:auto;border-radius:4px;display:block;margin:0 auto;">` : "<p style=\"color:#666;\">No image resolved.</p>") + L(e) : _o(e) + L(e));
	}, h = () => {
		if (p.current) {
	...
	return /* @__PURE__ */ (0, N.jsxs)(N.Fragment, { children: [
		/* @__PURE__ */ (0, N.jsx)("div", {
			className: `${P.overlay} ${r ? P.open : ""}`,
			onClick: t
		}),
		/* @__PURE__ */ (0, N.jsxs)("div", {
			className: `${P.panel} ${r ? P.open : ""}`,
			children: [
				/* @__PURE__ */ (0, N.jsxs)("div", {
					className: P.toolbar,
					children: [
						...
						/* @__PURE__ */ (0, N.jsx)("div", { className: P.toolbarSeparator }),
						/* @__PURE__ */ (0, N.jsxs)("div", {
							className: P.toolbarGroup,
							children: [
								/* @__PURE__ */ (0, N.jsx)("button", {
									className: `${P.tb} ${a ? P.active : ""}`,
									onClick: () => o(!a),
									title: "Article details",
									dangerouslySetInnerHTML: { __html: `${F.info}<span class="${P.tbTooltip}">Details</span>` }
								}),
								/* @__PURE__ */ (0, N.jsx)("button", {
									className: P.tb,
									onClick: _,
									title: "Export markdown",
									dangerouslySetInnerHTML: { __html: `${F.download}<span class="${P.tbTooltip}">Export</span>` }
								}),
								/* @__PURE__ */ (0, N.jsx)("button", {
									className: P.tb,
									onClick: g,
									title: "Copy to clipboard",
									dangerouslySetInnerHTML: { __html: `${F.copy}<span class="${P.tbTooltip}">Copy</span>` }
								})
							]
						}),
						/* @__PURE__ */ (0, N.jsx)("div", { className: P.toolbarSeparator }),
						/* @__PURE__ */ (0, N.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, N.jsx)("button", {
								className: `${P.tb} ${P.syndLink} ${P.canonical}`,
								onClick: v,
								dangerouslySetInnerHTML: { __html: `${F.link}<span class="${P.tbTooltip}">Copy URL</span>` }
								...
								return r ? /* @__PURE__ */ (0, N.jsx)("a", {
									...
									className: `${P.tb} ${P.syndLink}`,
									dangerouslySetInnerHTML: { __html: `${F[r.icon] || F.globe}<span class="${P.tbTooltip}">${r.label}</span>` }
								}, e) : null;
							})]
						}),
						/* @__PURE__ */ (0, N.jsx)("div", { className: P.toolbarSpacer }),
						/* @__PURE__ */ (0, N.jsx)("button", {
							className: `${P.tb} ${P.closeBtn}`,
							onClick: t,
							title: "Close",
							dangerouslySetInnerHTML: { __html: `${F.close}<span class="${P.tbTooltip}">Close</span>` }
						})
					]
				}),
				/* @__PURE__ */ (0, N.jsx)("div", {
				...
				/* @__PURE__ */ (0, N.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, N.jsxs)("div", {
						className: P.articleHeader,
						children: [
							/* @__PURE__ */ (0, N.jsx)("div", {
								className: P.articleTitle,
								children: e.title || e.label
							}),
							/* @__PURE__ */ (0, N.jsxs)("div", {
								className: P.articleByline,
							...
							y.length > 0 && /* @__PURE__ */ (0, N.jsx)("div", {
								className: P.articleMeta,
								children: y.join(" · ")
							}),
		...
		/* @__PURE__ */ (0, N.jsx)("div", {
			className: `${P.copyToast} ${d ? P.show : ""}`,
...
function I(e) {
	...
	return n += "<div style=\"color:var(--rp-accent);font-size:11px;text-transform:uppercase;letter-spacing:0.05em;margin-bottom:8px;\">also exists as</div>", n += `<div style="color:var(--rp-text);font-size:14px;">${t.map((e) => `<span class="${P.fmTag}">${e}</span>`).join(" ")}</div>`, n += "</div>", n;
}
function L(e) {
	let t = [];
	...
	for (let [e, r] of t) n += `<div class="${P.fmRow}"><span class="${P.fmLabel}">${e}</span><span class="${P.fmValue}">${r}</span></div>`;
	return n += "</div>", n;
}
function R({ article: e, settings: t }) {
	...
	return /* @__PURE__ */ (0, N.jsx)("div", {
		className: `${P.frontmatterPanel} ${P.open}`,
	...
	return t ? /* @__PURE__ */ (0, N.jsxs)("div", {
		...
		children: [
			r !== "playing" && /* @__PURE__ */ (0, N.jsx)("button", {
				...
				title: "Play",
				dangerouslySetInnerHTML: { __html: `${F.play}<span class="${vo.tbTooltip}">Play</span>` }
			}),
			r === "playing" && /* @__PURE__ */ (0, N.jsx)("button", {
				className: vo.tb,
				onClick: () => {
				...
				title: "Pause",
				dangerouslySetInnerHTML: { __html: `${F.pause}<span class="${vo.tbTooltip}">Pause</span>` }
			}),
			(r === "playing" || r === "paused" || r === "loading") && /* @__PURE__ */ (0, N.jsx)("button", {
				...
				title: "Stop",
				dangerouslySetInnerHTML: { __html: `${F.stop}<span class="${vo.tbTooltip}">Stop</span>` }
			}),
...
//#endregion
export { ho as GraphViewer, k as React, Vr as ReactDOM, go as ReaderPanel, yo as TTS };
